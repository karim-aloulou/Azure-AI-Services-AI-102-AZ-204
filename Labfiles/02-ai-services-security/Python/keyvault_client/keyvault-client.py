#Pour avoir les deux keys
# az cognitiveservices account keys list --name MyNewMultiServicAccount --resource-group Karim


#Pour regenerer le key1
# az cognitiveservices account keys regenerate --name MyNewMultiServicAccount -g Karim --key-name key1
